...
import { idlFactory } from './my_dao_project_frontend.did.js';
export { idlFactory } from './my_dao_project_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MY_DAO_PROJECT_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./my_dao_project_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the my_dao_project_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./my_dao_project_frontend.did.js")._SERVICE>}
 */
export const my_dao_project_frontend = createActor(canisterId);
